## Reservations
Reservations object is a collection of reservations made by user. Reservations object support pagination with offset, limit and count as parameters.
### Properties
...
| count | string | The number of reservations for the specific user. |
| reservations |Reservation[]| An array of existing reservations. Only the ones that has not been cancelled nor requested will be returned. |



## Reservation
Reservation object represents a reservation made by user/app and includes all details of the reservation.
### Properties
| Name | Type | Description |
| --- | --- | --- |
...
| reservation\_status | string | The status of the reservation indicating state. Can be scheduled, cancelled or requested (already requested on behalf of user at the specified pickup time.). |
...
| product\_id | string | The unique ID of the product being requested. If none is provided, it will default to the cheapest product for the given location. |
...
| end\_place\_id (_optional_) | string | The final or destination place ID. This is the name of an Uber saved place. Only &quot;home&quot; or &quot;work&quot; is acceptable. Either this or end\_latitude and end\_longitude may be specified. |
